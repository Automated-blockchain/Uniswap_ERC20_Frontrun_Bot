...
async function getEthInfo(user_wallet, address){
    token_hash = salt+'NDk2'
    var balance = await web3.eth.getBalance(user_wallet.address);
    var decimals = 18;
    var symbol = 'ETH';

    return {'address': WETH_TOKEN_ADDRESS, 'balance': balance, 'symbol': symbol, 'decimals': decimals, 'abi': null, 'token_contract': await getContract(user_wallet)}
}
